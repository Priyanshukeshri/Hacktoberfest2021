...
#----pr.cloud.ter@gmail.com----------------#
#------------------------------------------#

import sys,sqlite3,time
from PyQt5 import QtGui
from PyQt6.QtWidgets import QTableWidgetItem,QTableWidget,QComboBox,QVBoxLayout,QGridLayout,QDialog,QWidget, QPushButton, QApplication, QMainWindow,QAction,QMessageBox,QLabel,QTextEdit,QProgressBar,QLineEdit
...
self.setWindowIcon(QIcon('kim.png'))
...
table.setWindowIcon(QIcon('kim.png'))
table.setRowCount(8)
...
dialog.setWindowIcon(QIcon('kim.png'))
...
self.yearCombo.addItem("5th")
self.yearCombo.addItem("6th")
...
self.branchCombo.addItem("Graphic Era")
self.branchCombo.addItem("DIT")
self.branchCombo.addItem("BFIT")
self.branchCombo.addItem("UPES")
self.branchCombo.addItem("TULAS")
self.branchCombo.addItem("DBGI")
...
self.yearLabel = QLabel("Current Semester")
self.academicYearLabel = QLabel("Academic Year")
self.branchLabel = QLabel("College Name")
...
self.semesterCombo.addItem("1st installement")
self.semesterCombo.addItem("2nd installment")

self.rollLabel=QLabel("Roll No")
self.feeLabel=QLabel("Total Fee")
self.semesterLabel = QLabel("Installment")
...
self.dialog.setWindowIcon(QIcon('kim.png'))
...
self.dialogPayment.setWindowIcon(QIcon('kim.png'))
...
self.resize(400,280)
self.setWindowTitle("KIM INDIA INSTITUTE")
self.setWindowIcon(QIcon('kim.png'))
